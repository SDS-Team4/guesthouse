...
@Service
public class OpsPricePolicyAuditService {

    private static final String TARGET_TYPE_PRICE_POLICY = "PRICE_POLICY";

    private final AuditLogMapper auditLogMapper;
    private final ObjectMapper objectMapper;

    public OpsPricePolicyAuditService(AuditLogMapper auditLogMapper, ObjectMapper objectMapper) {
        this.auditLogMapper = auditLogMapper;
        this.objectMapper = objectMapper;
    }

    public void writePricePolicyAudit(
            SessionUser actor,
            Long policyId,
            String actionType,
            String reasonText,
        ...
        auditLogInsertParam.setTargetType(TARGET_TYPE_PRICE_POLICY);
        auditLogInsertParam.setTargetId(policyId);
    ...
    private String toJson(Object value) {
        ...
        try {
            ...
            throw new IllegalStateException("Failed to serialize price policy audit state.", exception);
        }
    }
}
