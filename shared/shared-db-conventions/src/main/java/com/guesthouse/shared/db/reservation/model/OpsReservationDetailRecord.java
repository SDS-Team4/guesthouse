...
public class OpsReservationDetailRecord {
    ...
    private LocalTime accommodationCheckOutTime;
    ...
    public LocalTime getAccommodationCheckOutTime() {
        return accommodationCheckOutTime;
    }

    public void setAccommodationCheckOutTime(LocalTime accommodationCheckOutTime) {
        this.accommodationCheckOutTime = accommodationCheckOutTime;
    }
